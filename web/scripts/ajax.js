...
function autocompleta(parola, target) {
	var regex = /a-z/;
	if (!parola.match(regex)) { //cambio tutto in minuscolo
		parola = parola.toLowerCase();
	}
	parola = JSON.stringify(parola);
	var uri = "./searchServlet?search="+parola;
	ar xhr = myGetXmlHttpRequest();
	if (xhr)
